	...
	<!-- nav -->
		...
		<div class="w3-container">
	  	<div class="w3-content" style="max-width:1200px">
		      ...
		      <h2 class="w3-center">피치뮤직 이달의 노래</h2>
					<div style="width: 350px; margin: auto;" class="mb-5 text-center ho" onclick="javascript:location.href='${ctp}/music/songinfor?idx=${vos[0].SJ_SONG_IDX }'">
						...
						<c:forEach var="vo" items="${vos}" varStatus="st">
							<tr>
								...
								<td class="align-middle" title="${vo.SJ_SONG_TITLE }">
									<a href="infor?idx=${vo.SJ_SONG_IDX }">
