		      ...
		      <tbody>
			      ...
			      <tr class="text-center">
			        <td class="con2" colspan="2">
			          <br>
			            <input class="btn" type="button" value="돌아가기" style="background: #f5d9da;;color:black;" onclick="location.href='${ctp}/user/notice?pag=${pag}&pageSize=${pageSize}';"/>
			        </td>
			      </tr>
		   		</tbody>
		    </table>
				  	...
				  	<tr style="border-bottom: 1px solid #E2E2E2;">
				  		...
				  		<td class="con2" align="left" style="padding-left: 30px;">
				  			<c:if test="${!empty pnVos[1]}">
									<a href="${ctp}/user/noticeContent?idx=${pnVos[1].SJ_NOTICE_IDX}&pag=${pag}&pageSize=${pageSize}">${pnVos[1].SJ_NOTICE_TITLE}</a><br/>
								</c:if>
				  		</td>
				  	</tr>
				  	<tr>
				  		...
				  		<td class="con2" align="left" style="padding-left: 30px;">
				  			<c:if test="${!empty pnVos[0]}">
									<a href="${ctp}/user/noticeContent?idx=${pnVos[0].SJ_NOTICE_IDX}&pag=${pag}&pageSize=${pageSize}">${pnVos[0].SJ_NOTICE_TITLE}</a><br/>
								</c:if>
				  		</td>
				  	</tr>
		  		</tbody>
